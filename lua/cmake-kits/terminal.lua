...
function M.create_window()
    ...
    M.set_title_colors(terminal_state.window.title.background, terminal_state.window.title.foreground)
    M.set_border_colors(terminal_state.window.border.background, terminal_state.window.border.foreground)
...
function M.set_window_colors(bg, fg)
    ...
    vim.api.nvim_set_hl(terminal_state.window.hightlight_ns, "NormalFloat",
        { bg = terminal_state.window.background, fg = terminal_state.window.foreground })
    vim.api.nvim_set_hl(terminal_state.window.hightlight_ns, "EndOfBuffer",
        { bg = terminal_state.window.background, fg = terminal_state.window.foreground })
end
...
function M.set_title_colors(bg, fg)
    ...
    vim.api.nvim_set_hl(terminal_state.window.hightlight_ns, "FloatTitle",
...
function M.set_border_colors(bg, fg)
    ...
    vim.api.nvim_set_hl(terminal_state.window.hightlight_ns, "FloatBorder",
        { bg = terminal_state.window.border.background, fg = terminal_state.window.border.foreground })
end
